...
public class PokBattle extends BaseFrame{
	// the fields
	...
	protected Pokemon[] player1,player2;
	protected Pokemon p1,p2;
	protected AI ai = new AI();
	protected ImageIcon arena,back;
		
	protected Image arenaImg,backImg;
	...
	public PokBattle(){
		super();
		mode = "battle";
		arena = new ImageIcon("Battle Pics\\arena.png");
		back = new ImageIcon("Battle Pics\\sky.jpg");
		arenaImg = arena.getImage(); 
		backImg = back.getImage();
		
		arenaImg = arenaImg.getScaledInstance(800,365,Image.SCALE_SMOOTH);
		backImg = backImg.getScaledInstance(800,600,Image.SCALE_SMOOTH);
		//retreatMenu = ret;
	...
	public void paint(Graphics g){
		if (introCount==0 && mode.equals("battle")){
			...
			if (mode.equals("battle")){
				...
				g.drawImage(arenaImg,0,600-365,null);
			...
			}else{// if (mode.equals("win")||mode.equals("lose")){
				g.setColor(Color.black);
